...
class BadParamsError extends Error {
	constructor() {
		...
		this.message = "A required parameter was omitted or invalid. a) Passwords dont match! b) Cookies teoken expired";
	}
}
...
class BadCredentialsError extends Error {
	constructor() {
		...
		this.message = "No user founded in the DB, the provided username";
	}
}
